...
<?php
	...
	$query="select Fname, Lname,email from customer where customerID not in (select customerID from orders where (select DATEDIFF(CURDATE(), date) < 60))";	
	$result = mysql_query($query);
	
	echo "<p>";
	echo "Inactive Customers: <br> <br>";
